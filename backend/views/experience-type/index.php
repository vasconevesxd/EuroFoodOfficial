...
/* @var $searchModel app\models\ExperienceTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Experience Types';
...
?>
    ...
    <p>
        <?= Html::a('Create Experience Type', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
...
<table class="table table-striped">
    ...
    <tbody>
    <?php $i = 1;  $status = '';?>
    <?php foreach ($experiencess as $experiences): ?>
